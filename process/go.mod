module github.com/sgaunet/supervisord/process
...
require (
	...
	github.com/sgaunet/supervisord/faults v0.0.0-20250610055946-d5a5470d11af // indirect
	github.com/sgaunet/supervisord/util v0.0.0-20250610055946-d5a5470d11af // indirect
